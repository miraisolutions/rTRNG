...
(*fair-playing*) simulation of any subset of the variables and simulations.
...
We now use Rcpp  to define functions `mcMatRcpp` and `mcSubMatRcpp` for the full
sequential simulation and the sub-simulation, respectively.
