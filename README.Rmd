...
An [introduction to
**rTRNG**](https://user2017.sched.com/event/Axpj/rtrng-advanced-parallel-random-number-generation-in-r) [[pdf](http://schd.ws/hosted_files/user2017/93/Mirai.rTRNG.useR2017.pdf)],
presented at the useR!2017 conference, and is also available as package vignette
```{r useR2017}
vignette("rTRNG.useR2017", "rTRNG")
```
For more information and references, you can browse the package documentation
